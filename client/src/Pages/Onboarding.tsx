...
const Onboarding = () => {
  ...
  return (
    <>
      ...
      <style>{`
        /*
          Styled per the Luffu reference. Luffu itself defines no dark mode —
          this is our own extrapolation of its language (one warm ground,
          near-black ink, one restrained dark-teal accent) inverted for a
          dark screen: Deep Ink becomes the page instead of the button, and
          a lightened parchment tone carries the text. Glow/blob decoration
          and heavy shadows are dropped — Luffu uses zero box-shadows and no
          decorative gradients anywhere in the system.
        */
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fit-brand-name {
          ...
          font-size: 20px; font-weight: 400; color: #ece7da; letter-spacing: -0.02em;
        }
        ...
        .fit-ghost {
          ...
          background: #1c2224; border: 1px solid #2a3234;
        ...
        .fit-step-pill {
          ...
          color: #9a9d94; letter-spacing: -0.01em;
        }
        ...
        .fit-dot.on {
          background: #c9932f; width: 20px;
        }

        .fit-prog {
          height: 2px; background: #2a3234;
        ...
        .fit-q-title {
          font-family: 'Playfair Display', serif;
          font-size: 22px; font-weight: 400; color: #ece7da;
          letter-spacing: -0.02em; margin-bottom: 4px; line-height: 1.2;
        }
        .fit-q-sub { font-size: 13px; color: #9a9d94; line-height: 1.4; letter-spacing: -0.01em; }

        .fit-field { margin-bottom: 12px; }
        .fit-label {
          display: block; font-size: 12px; font-weight: 500;
          color: #7d8079; letter-spacing: -0.01em; margin-bottom: 7px;
        }
        .fit-label-req { color: #c9932f; margin-left: 2px; }
        .fit-input {
          display: block; width: 100%;
          background: #14181a; border: 1px solid #2a3234;
          border-radius: 6px; padding: 13px 16px;
          font-size: 15px; font-family: 'Inter', sans-serif;
          color: #ece7da; font-weight: 400; outline: none;
        ...
        .fit-input::placeholder { color: #4a5254; }
        input[type=number]::-webkit-inner-spin-button,
        input[type=number]::-webkit-outer-spin-button { -webkit-appearance: none; }

        .fit-goals { display: flex; flex-direction: column; gap: 8px; }
        .fit-goal-btn {
          width: 100%; background: #14181a;
          border: 1px solid #2a3234; border-radius: 6px;
          padding: 13px 16px;
          font-size: 14px; font-weight: 400;
          font-family: 'Inter', sans-serif; color: #9a9d94;
          cursor: pointer; text-align: left;
          display: flex; align-items: center; gap: 10px;
          transition: all 0.18s ease;
        }
        .fit-goal-btn:hover { border-color: #424e52; color: #ece7da; }
        .fit-goal-btn.sel {
          border-color: #c9932f;
          background: #2b2412;
          color: #ece7da;
        ...
        .fit-goal-btn.sel .fit-goal-emoji { background: rgba(201,147,47,0.16); }

        .fit-targets { margin-top: 18px; }
        .fit-targets-title {
          font-size: 12px; font-weight: 500; color: #7d8079;
        ...
        .fit-slider-label {
          ...
          font-size: 12px; color: #9a9d94; font-weight: 400;
        }
        .fit-info {
          width: 14px; height: 14px; border-radius: 50%;
          border: 1px solid #424e52;
          display: inline-flex; align-items: center; justify-content: center;
          font-size: 8px; color: #7d8079; cursor: help; font-style: italic;
        }
        .fit-slider-val { font-size: 13px; font-weight: 600; color: #c9932f; }
        .fit-track {
        ...
        .fit-track-bar {
          ...
          background: #2a3234; border-radius: 2px; pointer-events: none;
        }
        .fit-fill {
        ...
        .fit-thumb {
          ...
          background: #c9932f; border: 2px solid #14181a;
          border-radius: 50%;
          pointer-events: none; transition: box-shadow 0.15s;
        }
        .fit-track:hover .fit-thumb {
          box-shadow: 0 0 0 6px rgba(201,147,47,0.18);
        }
        input.fit-range {
        ...
        .fit-back-btn {
          ...
          background: transparent; border: 1px solid #2a3234;
          border-radius: 6px; padding: 12px 18px;
          font-family: 'Inter', sans-serif; font-size: 13px;
          font-weight: 400; color: #9a9d94; cursor: pointer;
          transition: all 0.15s; white-space: nowrap;
        }
        .fit-back-btn:hover:not(:disabled) { color: #ece7da; border-color: #424e52; }
        ...
        .fit-continue-btn {
          ...
          font-weight: 500; color: #14181a; cursor: pointer;
        ...
        .fit-spinner {
          ...
          border: 2px solid rgba(20,24,26,0.3);
