      ...
      <div className="flex gap-2 flex-wrap mb-2">
        {WATER_BTNS.map((ml) => (
          <button
            key={ml}
            onClick={() => onAdd(ml)}
            className="px-3 py-1.5 rounded-xl text-xs font-semibold bg-blue-500 hover:bg-blue-600 text-white transition-colors cursor-pointer"
          >
            +{ml} ml
          </button>
        ))}
        <button
          ...
          className="px-3 py-1.5 rounded-xl text-xs font-semibold bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-900/60 transition-colors cursor-pointer"
        >
          Custom
        </button>
      </div>
      ...
      {showCustom && (
        <div className="flex gap-2 mb-3">
          <input
            ...
            className="flex-1 rounded-xl px-3 py-2 text-sm bg-white dark:bg-slate-800 border border-blue-200 dark:border-blue-700 text-gray-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-blue-400"
          />
          <button
            onClick={handleCustomAdd}
            className="px-4 py-2 rounded-xl text-xs font-semibold bg-blue-500 hover:bg-blue-600 text-white transition-colors cursor-pointer"
          >
            Add
          </button>
        </div>
