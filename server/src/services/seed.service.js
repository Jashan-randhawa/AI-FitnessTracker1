...
const SAMPLE_POSTS = [
  {
    ...
    excerpt:
      'Discover how small daily habits can dramatically increase your metabolic rate and help you burn more calories throughout the day.',
...
No single habit will transform your metabolism overnight. But combining these evidence-based strategies creates a powerful compound effect over time. Start with 2–3 changes and build from there.`,
  ...
  },
  {
    ...
    excerpt:
      'Learn how to track your macronutrients — protein, carbs, and fats — to achieve sustainable fat loss without feeling deprived.',
...
Macro counting is a skill that gets easier with practice. Give it 4–6 weeks before judging the results.`,
  ...
  },
  {
    ...
    excerpt:
      'Most people focus on workouts and nutrition but neglect sleep — the single most powerful recovery and performance enhancer available.',
...
Start treating sleep as a non-negotiable part of your fitness plan. It's the free performance enhancer your body has been waiting for.`,
  ...
  },
  {
    ...
    excerpt:
      'Starting strength training can feel overwhelming. This practical guide gives you everything you need to begin safely and effectively.',
...
Consistency over months beats perfection over weeks. Show up, lift, eat well, sleep — repeat.`,
  ...
  },
  {
    ...
    excerpt:
      "Mindful eating is a simple but powerful practice that helps you reconnect with your body's hunger signals and develop a healthier relationship with food.",
...
Start with just one mindful meal per day. That's enough to begin shifting your relationship with food.`,
  ...
  },
  {
    ...
    excerpt:
      'The "8 glasses a day" rule is outdated. Here\'s what the science actually says about optimal hydration for health and performance.',
...
/**
 * Seeds the blog collection on first boot, matching the original Strapi
 * bootstrap hook. Safe to call on every startup — it's a no-op once posts exist.
 */
const seedBlogPosts = async () => {
  ...
  await Blog.insertMany(SAMPLE_POSTS.map((post) => ({ ...post, publishedAt: new Date() })));
  console.log(`Bootstrap: seeded ${SAMPLE_POSTS.length} blog posts`);
};

module.exports = { seedBlogPosts, SAMPLE_POSTS };
